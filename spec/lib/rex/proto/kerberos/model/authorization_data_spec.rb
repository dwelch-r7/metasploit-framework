...
=end
  ...
  let(:authorization_data_sample) do
  ...
  describe "#decode" do
    it 'decodes without errors' do
      authorization_data.decode(authorization_data_sample)
    end

    describe  "decoded Authorization Data" do

      subject(:ticket_enc_part_decoded) do
        authorization_data.decode(authorization_data_sample)
      end

      it "decodes the elements correctly" do
        expect(ticket_enc_part_decoded.elements.length).to eq(1)
      end

      it "decodes type correctly" do
        expect(ticket_enc_part_decoded.elements.first[:type]).to eq(1)
      end

      it "decodes data correctly" do
        expect(ticket_enc_part_decoded.elements.first[:data]).to eq(expected_ad_data)
      end
    end
  end
