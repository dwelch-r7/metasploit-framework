...
module Msf::OptionalSession
  ...
  def setup
    ...
    if session
      ...
      check_for_session_readiness if session.type == "meterpreter" # TODO: move elsewhere
  ...
  def check_for_session_readiness(tries=6)# TODO: move elsewhere
  ...
  def sysinfo
    begin
      @sysinfo ||= session.sys.config.sysinfo # TODO: change this
